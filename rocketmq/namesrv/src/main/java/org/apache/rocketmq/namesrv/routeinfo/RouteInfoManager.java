        ...
        try {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    //如果根据地址找到节点后并且brokerid发生变化 把它移除
                ...
                if (null != topicConfigWrapper
                    ...
                    //如果第一次注册或者数据版本发生变化 那么全量替换所有的topic配置信息
             ...
             //如果是从节点 这里会查找主节点的地址以及主节点监听主从同步的地址并且会返回给从节点
                // 所以需要先启动主节点 再启动从节点 否则从节点无法找到主节点
