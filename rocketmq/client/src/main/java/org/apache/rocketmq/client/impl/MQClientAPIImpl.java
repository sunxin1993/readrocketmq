...
public class MQClientAPIImpl {
    ...
    private SendResult processSendResponse(
        ...
        //已经有人在github提出 issue
        switch (response.getCode()) {
            //没有break的情况 会顺序执行后面所有case里面的代码块包括 default 不会根据case进行判断
    ...
    public TopicRouteData getTopicRouteInfoFromNameServer(final String topic, final long timeoutMillis,
       ...
       //数据封装 封装成的格式为 RemotingCommand code RequestCode.GET_ROUTEINTO_BY_TOPIC
        //                                      requestHeader   requestHeader包含topic属性
                                              //  version      版本号
